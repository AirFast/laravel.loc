                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 d-flex mb-4 mb-lg-0">
                                ...
                                <div class="user-avatar-box">
                                    ...
                                    @if($user->hasVerifiedEmail())
                                        <span class="verified-user has-label text-success">
                                    ...
                                    @else
                                        <span class="not-verified-user has-label text-danger">
                            ...
                            <div class="col-lg-8">
                                ...
                                <p>
                                    ...
                                    {{ $user->role->name ? __( 'adminpanel.user.table.' . $user->role->name ) : 'N/A' }}
                                </p>
