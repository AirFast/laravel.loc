                                            ...
                                            <td>{{ $territory->number }}
                                                ...
                                                @if($territory->user_id == 0 && $territory->status == 'pending')
                                                    <a href="{{ route( 'admin.territories.edit', [app()->getLocale(), $territory->id] ) }}">
                                                        <span class="territory-warning has-label right-side text-primary">
                                                        ...
                                                        <span class="label">{{ __( 'adminpanel.territories.message.territory-warning' ) }}</span>
                                                    </span>
                                                    </a>
                                                @endif
                                                ...
                                                @if($territory->user_id != 0 && $territory->status == 'pending')
                                                    <a href="{{ route( 'admin.territories.edit', [app()->getLocale(), $territory->id] ) }}">
                                                        <span class="territory-pending has-label right-side text-success">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                                                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                                                            </svg>
                                                            <span class="label">{{ __( 'adminpanel.territories.message.territory-pending', [ 'name' => $territory->user->name ] ) }}</span>
                                                        </span>
                                                    </a>
                                                @endif
                                                ...
                                                @foreach($territory->territoryPeriod as $period)
                                                    ...
                                                    @if($period->in_process)
                                                        ...
                                                        @if($dt->toDay() > $dt->createFromFormat( 'Y-m-d', $period->time_start )->addMonth( 4 ))
                                                            <a href="{{ route( 'admin.territories.edit', [app()->getLocale(), $territory->id] ) }}">
                                                                <span class="territory-time-end has-label right-side text-danger">
                                                                    ...
                                                                    <span class="label">{{ __( 'adminpanel.territories.message.territory-end-short' ) }}</span>
                                                                </span>
                                                            </a>
                                                        @endif
